...
#import "GYKJPushService.h"
#import <CommonCrypto/CommonDigest.h>
#import <AVFoundation/AVFoundation.h>
#import <UserNotifications/UserNotifications.h>

@interface GYKJPushService()<UNUserNotificationCenterDelegate>

@end

@implementation GYKJPushService
...
+ (instancetype)defaultPushService{
    static GYKJPushService *instance = nil;
...
- (void)PushApplication:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo
{
    ...
    [self PushApplication:application didReceiveRemoteNotification:userInfo fetchCompletionHandler:NULL];
}
